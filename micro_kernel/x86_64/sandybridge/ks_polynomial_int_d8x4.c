    ...
    )
{
  ...
  // --------------------------------------------------------------------------
  // Finish rank-k update, now first scale with "scal" and shift with "cons".
  // --------------------------------------------------------------------------
  ...
  // --------------------------------------------------------------------------
  // pow( C, p ) = exp( p * ln( C ) )
  tmp.v     = _mm256_broadcast_sd( &powe );
  if ( powe == 2.0 ) {
    ...
    c03_0.v   = _mm256_pow_pd( c03_0.v, tmp.v ); 
    c03_1.v   = _mm256_pow_pd( c03_1.v, tmp.v ); 
    c03_2.v   = _mm256_pow_pd( c03_2.v, tmp.v ); 
    c03_3.v   = _mm256_pow_pd( c03_3.v, tmp.v ); 
    c47_0.v   = _mm256_pow_pd( c47_0.v, tmp.v ); 
    c47_1.v   = _mm256_pow_pd( c47_1.v, tmp.v ); 
    c47_2.v   = _mm256_pow_pd( c47_2.v, tmp.v ); 
    c47_3.v   = _mm256_pow_pd( c47_3.v, tmp.v );
  }
...
//  v4df_t maske, maskm;
//  v4df_t c_exp, c_man;
//  v4df_t e03_0, e03_1, e03_2, e03_3;
//  v4df_t e47_0, e47_1, e47_2, e47_3;
//  v4li_t itmp0, itmp1;
//  v4li_t i1023;
//
//  __m256i i256tmp;
//
//  // Step#1: convert c into integer type. Apply two masks to separte 
//  //         exponent and mantissa.
//  maske.v   = _mm256_set1_pd( 0x7FF0000000000000 );
//  maskm.v   = _mm256_set1_pd( 0x000FFFFFFFFFFFFF );
//  i1023.v   = _mmset1_epi64( 1023 );
//
//  // Extract the exeponent part
//  e03_0.v   = _mm256_and_pd( c03_3.v, maske.v );
//  // Use 2 128i register to shift
//  i256tmp   = _mm256_castpd_si256( e03_0.v );
//  itmp0.v   = _mm256_extractf128_si256( i256tmp, 0 );
//  itmp1.v   = _mm256_extractf128_si256( i256tmp, 1 );
//  itmp0.v   = _mm_srli_epi64( itmp0.v, 52 );
//  itmp1.v   = _mm_srli_epi64( itmp1.v, 52 );
//  itmp0.v   = _mm_sub_epi64( itmp0.v, i1023.v);
//  itmp1.v   = _mm_sub_epi64( itmp1.v, i1023.v);
//  i256tmp   = _mm256_set_m128i( itmp1.v, itmp0.v );
//  //e03_0.v   = _mm256_


//  k03_0.v       = _mm256_and_pd( c03_0.v, maske.v );
//  k03_1.v       = _mm256_and_pd( c03_1.v, maske.v );
//  k03_2.v       = _mm256_and_pd( c03_2.v, maske.v );
//  k03_3.v       = _mm256_and_pd( c03_3.v, maske.v );
//  k47_0.v       = _mm256_and_pd( c47_0.v, maske.v );
//  k47_1.v       = _mm256_and_pd( c47_1.v, maske.v );
//  k47_2.v       = _mm256_and_pd( c47_2.v, maske.v );
//  k47_3.v       = _mm256_and_pd( c47_3.v, maske.v );
