    ...
    )
{
  ...
  aa_tmp.v    = _mm256_broadcast_sd( &dzero );
  c03_0.v  = _mm256_max_pd( aa_tmp.v, c03_0.v );
  c03_1.v  = _mm256_max_pd( aa_tmp.v, c03_1.v );
  c03_2.v  = _mm256_max_pd( aa_tmp.v, c03_2.v );
  c03_3.v  = _mm256_max_pd( aa_tmp.v, c03_3.v );
  c47_0.v  = _mm256_max_pd( aa_tmp.v, c47_0.v );
  c47_1.v  = _mm256_max_pd( aa_tmp.v, c47_1.v );
  c47_2.v  = _mm256_max_pd( aa_tmp.v, c47_2.v );
  c47_3.v  = _mm256_max_pd( aa_tmp.v, c47_3.v );
