    ...
    )
{
  ...
  u03.v    = _mm256_fmadd_pd( w_tmp.v, c03_0.v, u03.v );
  u47.v    = _mm256_fmadd_pd( w_tmp.v, c47_0.v, u47.v );
  
  w_tmp.v  = _mm256_broadcast_sd( (double*)( w + 1 ) );
  u03.v    = _mm256_fmadd_pd( w_tmp.v, c03_1.v, u03.v );
  u47.v    = _mm256_fmadd_pd( w_tmp.v, c47_1.v, u47.v );

  w_tmp.v  = _mm256_broadcast_sd( (double*)( w + 2 ) );
  u03.v    = _mm256_fmadd_pd( w_tmp.v, c03_2.v, u03.v );
  u47.v    = _mm256_fmadd_pd( w_tmp.v, c47_2.v, u47.v );

  w_tmp.v  = _mm256_broadcast_sd( (double*)( w + 3 ) );
  u03.v    = _mm256_fmadd_pd( w_tmp.v, c03_3.v, u03.v );
  u47.v    = _mm256_fmadd_pd( w_tmp.v, c47_3.v, u47.v );
