    ...
    )
{
  ...
  c81_0.v  = _mm256_mul_pd( aa_tmp.v, c81_0.v );
  c81_1.v  = _mm256_mul_pd( aa_tmp.v, c81_1.v );
  c81_2.v  = _mm256_mul_pd( aa_tmp.v, c81_2.v );
  c81_3.v  = _mm256_mul_pd( aa_tmp.v, c81_3.v );
  ...
  c81_0.v  = _mm256_max_pd( c_tmp.v, c81_0.v );
  c81_1.v  = _mm256_max_pd( c_tmp.v, c81_1.v );
  c81_2.v  = _mm256_max_pd( c_tmp.v, c81_2.v );
  c81_3.v  = _mm256_max_pd( c_tmp.v, c81_3.v );


  // Preload u03, u47
  u03.v    = _mm256_load_pd( (double*)u );
  u47.v    = _mm256_load_pd( (double*)( u + 4 ) );
  u81.v    = _mm256_load_pd( (double*)( u + 8 ) );
