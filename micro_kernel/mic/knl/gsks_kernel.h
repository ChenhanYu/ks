...
void KERNEL1(rank_k_int_d24x8,double);
void KERNEL1(rank_k_asm_d24x8,double);
void KERNEL2(gaussian_int_d24x8,double);
void KERNEL2(gaussian_ref_d24x8,double);
void KERNEL2(polynomial_int_d24x8,double);
